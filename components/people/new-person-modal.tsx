    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Crea un nuovo personale o assegna una persona esistente a questa
            struttura
          </DialogDescription>
        </DialogHeader>
        ...
        <Tabs defaultValue="new" className="space-y-6">
          ...
          <TabsContent value="existing">
            {loadingPeople ? (
              ...
              <p className="text-center text-muted-foreground py-8">
                Nessun personale disponibile da assegnare. Tutto il personale
                dell'organizzazione è già assegnato a questa struttura.
              </p>
            ) : (
