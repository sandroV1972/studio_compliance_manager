          ...
          {status === "success" && (
            <div className="space-y-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800">
                <p className="font-semibold mb-2">Il tuo account è in attesa di approvazione</p>
                <p>Un amministratore esaminerà la tua richiesta e riceverai una notifica via email quando il tuo account sarà attivato.</p>
              </div>
              <Button
          ...
          {status === "error" && (
            <div className="space-y-4">
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-sm text-red-800">
                <p>Il link di verifica potrebbe essere scaduto o non valido. Contatta l'amministratore per assistenza.</p>
              </div>
              <Button
                onClick={() => router.push("/auth/login")}
                className="w-full"
